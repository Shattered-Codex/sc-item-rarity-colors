...
export function registerModuleSettings(MODULE_ID) {
  ...
  registerColorSetting(MODULE_ID, "common-text-color", "Common Text Color", "#000000");
  registerColorSetting(MODULE_ID, "uncommon-item-color", "Uncommon Item Color", "#00ff00");
  registerColorSetting(MODULE_ID, "uncommon-text-color", "Uncommon Text Color", "#000000");
  registerColorSetting(MODULE_ID, "rare-item-color", "Rare Item Color", "#0000ff");
  registerColorSetting(MODULE_ID, "rare-text-color", "Rare Text Color", "#ffffff");

  registerColorSetting(MODULE_ID, "veryrare-item-color", "Very Rare Item Color", "#ff00ff");
  registerColorSetting(MODULE_ID, "veryrare-text-color", "Very Rare Text Color", "#ffffff");
  ...
  registerColorSetting(MODULE_ID, "legendary-text-color", "Legendary Text Color", "#000000");
  ...
  registerColorSetting(MODULE_ID, "artifact-text-color", "Artifact Text Color", "#ffffff");
